...
public class HBaseUtil {
    ...
    public static Connection getHBaseConnection() throws IOException {
        ...
        Connection hbaseConn = JdbcConnection.ConnectionFactory.createConnection(conf);
        return hbaseConn;
    }

    //关闭Hbase连接
    public static void closeHBaseConnection(Connection hbaseConn) throws IOException, SQLException {
